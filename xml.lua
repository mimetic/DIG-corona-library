...
--      * tagLowercase
--
--        Convert tag names to lowercase, e.g. "MyTag" => "mytag"
--        Default is true
--
--      * expandEntities
--
...
-- This should speed it up a little bit:
...
function X.xmlParser(handler)
	...
	obj.parseFile = function(self, xmlFileName)
		...
		if (not err) then
			...
			self:_err(self._errstr.loadFileErr, err)
		end
	end
    ...
    obj._errstr = { xmlErr = "Error Parsing XML",
                    ...
                    loadFileErr = "Unable to load file",
                  }
    ...
    obj._parseTag = function(self,s)
    	...
    	local useLower = self.options.tagLowercase

		    	local function useLowercaseTag(t)
					if useLower then
						return lower(t)
					else
						return t
        ...
        gsub(s,self._ATTR1,function (k,v)
                                attrs[useLowercaseTag(k)]=self:_parseEntities(v)
                                attrs._ = 1
                           end)
